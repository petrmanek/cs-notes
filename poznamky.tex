...
\include{kombagra/2vytvorky}
\include{kombagra/3roviny}
\include{kombagra/4toky}
\include{kombagra/5parovani}
\include{kombagra/6souvislost}
\include{kombagra/7ramsey}

\include{kombagra/11parovani2}
